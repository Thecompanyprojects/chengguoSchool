...
@interface SigninlistVC ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation SigninlistVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"签到预警提示";
...
-(UIButton *)sendBtn0
{
    if(!_sendBtn0)
    {
        ...
        [_sendBtn0 setTitle:@"今日" forState:normal];
    }
    return _sendBtn0;
}
...
-(UIButton *)sendBtn1
{
    if(!_sendBtn1)
    {
        ...
        [_sendBtn1 setTitle:@"昨日" forState:normal];
    }
    return _sendBtn1;
}
...
-(UIButton *)typeBtn0
{
    if(!_typeBtn0)
    {
        ...
        [_typeBtn0 setTitle:@"连续三天" forState:normal];
    }
    return _typeBtn0;
}
...
-(UIButton *)typeBtn1
{
    if(!_typeBtn1)
    {
        ...
        [_typeBtn1 setTitle:@"已签到" forState:normal];
    }
    return _typeBtn1;
}
...
-(UIButton *)typeBtn2
{
    if(!_typeBtn2)
    {
        ...
        [_typeBtn2 setTitle:@"未签订" forState:normal];
    }
    return _typeBtn2;
}
...
-(UITableView *)tableView
{
    if(!_tableView)
    {
        ...
        _tableView.frame = CGRectMake(20, 88+90, kScreenWidth-40, kScreenHeight-90-88);
