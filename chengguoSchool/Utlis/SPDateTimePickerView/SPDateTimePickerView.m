...
- (UIView *)contentView {
    if (!_contentView) {
        _contentView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight, ScreenWith, 360)];
...
- (UIPickerView *)pickerView {
    if (!_pickerView) {
        _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 40, [UIScreen mainScreen].bounds.size.width, 220)];
...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        ...
        [_cancelButton setTitleColor:UIColorFromRGB(0xFBA603) forState:UIControlStateNormal];
...
- (UIButton *)chooseButton {
    if (!_chooseButton) {
        ...
        [_chooseButton setTitleColor:UIColorFromRGB(0xFBA603) forState:UIControlStateNormal];
...
- (UIView*)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    label.textColor = RGBA(0x000000, 1);
    switch (self.pickerViewMode) {
        case 0:
        {
            switch (component) {
...
- (void)showDateTimePickerView{
    ...
    [UIView animateWithDuration:0.25f animations:^{
        self.alpha = 1;
        self.contentView.frame = CGRectMake(0, ScreenHeight-360, ScreenWith, 360);
...
- (void)hideDateTimePickerView{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        self.alpha = 0;
        self.contentView.frame = CGRectMake(0, ScreenHeight, ScreenWith, 360);
    } completion:^(BOOL finished) {
